...
send_completions() {
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-keda\'*\'--cluster-name\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "chronom-cluster")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-keda\'*\'--region\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "eu-north-1")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-keda\'*\'-n\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "chronom-cluster")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-keda\'*\'-r\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "eu-north-1")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--create-rsa-key --help --key-pair-name --max-nodes --min-nodes --name --node-type --region --setup-calico-cni --skip-gp3-setup --version -h -n -r -v")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $''
  echo $'    \'upgrade\'*)'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--help -h chronom chronom-keda")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  echo $'    \'create\'*)'
