...
send_completions() {
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-temp\'*\'--cluster-name\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "chronom-cluster")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-temp\'*\'--region\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "eu-north-1")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-temp\'*\'-n\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "chronom-cluster")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-temp\'*\'-r\')'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "eu-north-1")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'upgrade chronom-temp\'*)'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--cluster-name --help --namespace --region -h -n -r")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--create-rsa-key --help --key-pair-name --max-nodes --min-nodes --name --node-type --region --skip-calico-setup --skip-gp3-setup --version -h -n -r -v")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  ...
  echo $''
  echo $'    \'upgrade\'*)'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--help -h chronom chronom-temp")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  echo $'    \'create\'*)'
  ...
  echo $''
  echo $'    \'setup\'*)'
  echo $'      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_chronom-cli_completions_filter "--help -h auto-complete cloudshell install")" -- "$cur" )'
  echo $'      ;;'
  echo $''
  echo $'    \'list\'*)'
